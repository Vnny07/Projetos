...
label_bg.place(relx=0.5, rely=0.79, anchor='center')
...
label_codigo = tk.Label(frame_info, text="Código:", font=small_font)
label_codigo.grid(row=0, column=1, sticky="w")

label_mac = tk.Label(frame_info, text="MAC:", font=small_font)
label_mac.grid(row=1, column=1, sticky="w")

label_descricao = tk.Label(frame_info, text="Descrição:", font=small_font)
...
label_dia = tk.Label(janela, text="Consumo do dia atual:", font=small_font)
label_dia.pack(anchor='w', padx=(10, 0), pady=(10, 0))

label_mes_atual = tk.Label(janela, text="Consumo do mês atual:", font=small_font)
label_mes_atual.pack(anchor='w', padx=(10, 0), pady=(5, 0))

label_mes_anterior = tk.Label(janela, text="Consumo do mês anterior:", font=small_font)
...
label_custo_dia = tk.Label(janela, text="Custo do dia atual:", font=small_font)
label_custo_dia.pack(anchor='w', padx=(10, 0), pady=(10, 0))

label_custo_mes_atual = tk.Label(janela, text="Custo do mês atual:", font=small_font)
label_custo_mes_atual.pack(anchor='w', padx=(10, 0), pady=(5, 0))

label_custo_mes_anterior = tk.Label(janela, text="Custo do mês anterior:", font=small_font)
